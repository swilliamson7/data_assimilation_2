...
function cost_gradient_eval(F, G, k_guess, params_adjoint)
...
# fg!_closure(F, G, k) = cost_gradient_eval(F, G, k, params_adjoint)

# obj_fg = Optim.only_fg(fg!_closure)

# result_fg!_closure = Optim.optimize(obj_fg, [31.], Optim.LBFGS(), Optim.Options())