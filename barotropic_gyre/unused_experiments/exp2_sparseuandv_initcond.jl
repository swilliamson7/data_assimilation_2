...
function run_exp2()
    ...
    ekf_avgu, ekf_avgv = run_ensemble_kf(ekf_model, param_guess;udata=true,vdata=true,etadata=false)
    ...
    return ekf_avgu, ekf_avgv, dS, data, true_states, result, S_adj, states_adj, S_pred, pred_states
